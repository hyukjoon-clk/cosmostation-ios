...
extension Sui_Rpc_V2_Bcs: @unchecked Sendable {}
...
extension Sui_Rpc_V2_Bcs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Bcs"
  ...
  static func ==(lhs: Sui_Rpc_V2_Bcs, rhs: Sui_Rpc_V2_Bcs) -> Bool {
