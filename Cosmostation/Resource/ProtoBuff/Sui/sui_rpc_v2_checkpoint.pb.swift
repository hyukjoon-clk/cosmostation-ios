...
struct Sui_Rpc_V2_Checkpoint {
  ...
  var summary: Sui_Rpc_V2_CheckpointSummary {
  ...
  var signature: Sui_Rpc_V2_ValidatorAggregatedSignature {
  ...
  var contents: Sui_Rpc_V2_CheckpointContents {
  ...
  var transactions: [Sui_Rpc_V2_ExecutedTransaction] = []
...
extension Sui_Rpc_V2_Checkpoint: @unchecked Sendable {}
...
extension Sui_Rpc_V2_Checkpoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Sui_Rpc_V2_Checkpoint, rhs: Sui_Rpc_V2_Checkpoint) -> Bool {
